...
def modifyBuildDescription() {
    def DOCKER_IMAGE_NAME = "eric-oss-adc-app-engineering"
    def VERSION = readFile('.bob/var.version').trim()
    def DOCKER_IMAGE_DOWNLOAD_LINK = "https://armdocker.rnd.ericsson.se/artifactory/proj-eric-oss-drop-docker-global/proj-eric-oss-drop/${DOCKER_IMAGE_NAME}/${VERSION}/"
